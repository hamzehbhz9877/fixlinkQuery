...
import {FaArrowCircleLeft, FaCopy, FaExclamationTriangle} from "react-icons/fa";
    ...
    return (
        <section className="short-link center-content">
            <div className="card short-link--card custom--card">
                ...
                <div className="input-group short-link__input">
                    ...
                    <div className="input-group-prepend">
                        <Tooltip tooltipText="کپی شد" direction="left" clickable closeDelay={3000}>
            ...
            <div className="card short-link__alert text-center">
                <p>
                    <span className="text-warning"><FaExclamationTriangle/></span>
                    &nbsp;
                    ...
                    &nbsp;
                    {
                        !user ? <>
                            ...
                            ساختن <span className="short-link__alert-warning">لینک نامحدود</span>
                            &nbsp;
