    ...
    return (
        <div className="action" ref={clickRef}>
            <div className="profile" onClick={openMenu}>
                ...
                <span className="angle" ref={angleRef}><FaAngleDown/></span>
            </div>
            <div className="menu" ref={menuRef}>
                <ul>
                    <AccessControl userPermissions={[role]} allowedPermissions={["Owner", "Admin"]}
                    >
                        <li className="dd-li">
                            <FaUserTie/>
                    ...
                    <li className="dd-li">
                       <FaSignOutAlt/>
                        <NavLink to="/account/logout" className="nav-link">خروج</NavLink>
                    </li>
                </ul>
            </div>
        </div>
