...
export const accessDeny = Loadable(
    () =>
        import(
            /* webpackChunkName:"accessDeny" */ "domain/common/accessDeny"
            ),
...
export const logout = Loadable(
    () =>
        import(
            /* webpackChunkName:"logout" */ "domain/common/logout"
            ),
    {fallback: <AsyncLoading/>}
);
...
export const register = Loadable(
    () =>
        import(
            /* webpackChunkName:"register" */ "domain/main/register"
            ),
    {fallback: <AsyncLoading/>}
);
...
export const login = Loadable(
    () =>
        import(
            /* webpackChunkName:"login" */ "domain/main/login"
            ),
    {fallback: <AsyncLoading/>}
);
...
export const shortLink = Loadable(
    () =>
        import(
            /* webpackChunkName:"shortLink" */ "domain/main/shortLink"
            ),
    {fallback: <AsyncLoading/>}
);
export const contactUs = Loadable(
    () =>
        import(
            /* webpackChunkName:"contactUs" */ "domain/main/contactUs"
            ),
    {fallback: <AsyncLoading/>}
);
...
export const notifications = Loadable(
    () =>
        import(
            /* webpackChunkName:"notifications" */ "domain/main/notification"
            ),
    {fallback: <AsyncLoading/>}
);
...
export const rules = Loadable(
    () =>
        import(
            /* webpackChunkName:"rules" */ "domain/main/rules"
            ),
    {fallback: <AsyncLoading/>}
);
...
export const main = Loadable(
    () =>
        import(
            /* webpackChunkName:"home" */ "domain/main/info"
            ),
    {fallback: <AsyncLoading/>}
);
...
export const user = Loadable(
    () =>
        import(
            /* webpackChunkName:"users" */ "domain/panel/admin/users"
            ),
    {fallback: <AsyncLoading/>}
);
...
export const adminUser = Loadable(
    () =>
        import(
            /* webpackChunkName:"adminUsers" */ "domain/panel/admin/adminUsers"
            ),
    {fallback: <AsyncLoading/>}
);
...
export const linkState = Loadable(
    () =>
        import(
            /* webpackChunkName:"linkState" */ "domain/panel/user/linkState"
            ),
    {fallback: <AsyncLoading/>}
);
...
export const qrCode = Loadable(
    () =>
        import(
            /* webpackChunkName:"qrCode" */ "domain/panel/user/qrCode"
            ),
    {fallback: <AsyncLoading/>}
);
